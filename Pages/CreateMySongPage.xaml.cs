...
namespace App1.Pages
{
    ...
    public sealed partial class CreateMySongPage : Windows.UI.Xaml.Controls.Page
    {
        ...
        public CreateMySongPage()
        {
            this.InitializeComponent();
            this.Loaded += CreateMySongPage_Loaded;
        }

        private void CreateMySongPage_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private async void Button_CreateSong(object sender, RoutedEventArgs e)
        {
            ...
            bool result = await songService.CreateMySong(songCreate);
